...
//            preparedStatement.setInt(2, newFood.getPrice());
    ...
    public List<Food> getBy(Category category) {
        ...
        try {
            preparedStatement = connectionForDatabase.getConnection().prepareStatement(GET_ALL_BY_CATEGORY);
    ...
    public void create(Food food) {
        ...
        try {
            preparedStatement2 = connectionForDatabase.getConnection().prepareStatement(SELECT);
